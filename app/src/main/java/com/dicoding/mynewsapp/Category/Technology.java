...
import com.dicoding.mynewsapp.Retrofit.RetSport;
import com.dicoding.mynewsapp.Retrofit.RetTechnology;
...
//    public void onCreate(@NonNull Bundle savedInstanceState) {
    private void addItem() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(RetTechnology.BASE_URL)
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        RetTechnology retrofitnya = retrofit.create(RetTechnology.class);
